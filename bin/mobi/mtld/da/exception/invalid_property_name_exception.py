...
class InvalidPropertyNameException(DeviceAtlasException):
 """
 InvalidPropertyNameException is thrown by the API class when there is an
 attempt to fetch a property that is unknown for the supplied user agent or
 tree.
 """
 pass
