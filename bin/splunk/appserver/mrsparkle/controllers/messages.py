...
class MessagesController(BaseController):
    ...
    msg_map = {
        ...
        'Splunk must be restarted for changes to take effect.':  deferred_ugettext('Splunk must be restarted for changes to take effect.  [[/manager/search/control|Click here to restart from the Manager]].')
    }
